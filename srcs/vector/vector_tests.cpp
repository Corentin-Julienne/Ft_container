...
/*   Updated: 2022/12/15 16:25:21 by cjulienn         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	test_constructors(Colors &col) // to test
{
	...
	std::cout << col.bdBlue() << "Testing basic constructors (empty vector)" << col.reset() << std::endl;
	
	std::cout << col.yellow() << "Trying with an int vector..." << col.reset() << std::endl;
	...
	std::cout << col.yellow() << "Trying with a std::string vector..." << col.reset() << std::endl;
	...
	std::cout << col.bdBlue() << "Testing the following adavanced constructor : " << std::endl <<
	"explicit vector (size_type n, const value_type& val = value_type(), const allocator_type& alloc = allocator_type());"
	<< col.reset() << std::endl;
	
	std::cout << col.yellow() << "testing with an int vector" << col.reset() << std::endl;
	...
	std::cout << col.yellow() << "testing with a std::string vector" << col.reset() << std::endl;
	...
	std::cout << col.yellow() << "Testing with an int but filling 0 times the val 42" << col.reset() << std::endl;
	...
	std::cout << col.bdBlue() << "Testing with the following adavanced constructor : " << std::endl
	<< "template <class InputIterator>" << std::endl <<
	"vector (InputIterator first, InputIterator last, const allocator_type& alloc = allocator_type());" 
	<< col.reset() << std::endl;

	std::cout << col.yellow() << "Testing with a vector of int" << col.reset() << std::endl;
	...
	std::cout << col.yellow() << "Testing with a vector of std::string" << col.reset() << std::endl;
	...
	std::cout << col.bdBlue() << "Testing with copy constructor" << col.reset() << std::endl; // ok till there
	...
	std::cout << col.yellow() << "testing if modify one modify the other one" << col.reset() << std::endl;
	copy.push_back(666);
	...
	std::cout << std::endl << col.bdBlue() << "Testing with overloaded operator =" << col.reset() << std::endl;
	...
	separator(col);
	std::cout << col.bdYellow() << "Constructors tests over" << col.reset() << std::endl;
	separator(col);
}
...
static void	test_iterator(Colors &col) // to test
{
	...
	std::cout << col.bdBlue() << "Testing iterator arithmetic..." << col.reset() << std::endl;
	
	std::cout << col.yellow() << "Testing -- operator..." << col.reset() << std::endl;
	...
	std::cout << col.yellow() << "Testing --(int) operator" << col.reset() << std::endl;
	...
	std::cout << col.yellow() << "Testing a mix of iterator arithmetics..." << col.reset() << std::endl;
	...
	std::cout << col.yellow() << "Testing -> operator (* operator has already being tested a lot)" 
	<< col.reset() << std::endl;
	// TO IMPLEMENT

	std::cout << col.bdBlue() << "Testing relationnal operators..." << col.reset() << std::endl;

	std::cout << col.yellow() << "Testing == and !=" << col.reset() << std::endl;
	...
	std::cout << col.yellow() << "Testing < and > operators..." << col.reset() << std::endl;
	...
	separator(col);
	std::cout << col.bdYellow() << "iterator tests over" << col.reset() << std::endl;
	separator(col);
}
...
static void	test_reverse_iterator(Colors &col) // to test
{
	...
	std::cout << col.bdBlue() << "Testing reverse_iterator arithmetic..." << col.reset() << std::endl;
...
static void	test_capacity_methods(Colors &col) // to test
{
	...
	/* MAX SIZE */
	std::cout << col.bdBlue() << "Testing max_size method..." << col.reset() << std::endl;
	std::cout << "test.max_size = " << test.max_size() << std::endl << std::endl;

	/* RESIZE */
	std::cout << col.bdBlue() << "Testing resize method" << col.reset() << std::endl;

	/* If n is smaller than the current container size,
	the content is reduced to its first n elements, removing those beyond (and destroying them). */
	std::cout << col.yellow() << "resize with n smaller to current container size" << col.reset() << std::endl;
	...
	std::cout << col.yellow() << "resize with n greater than the vector size" << col.reset() << std::endl;
	...
	std::cout << col.yellow() << "adding an element to the vector but without initializing it" << col.reset() << std::endl;
	test.resize(6);
	std::cout << "display the updated vector" << std::endl;
	for (std::size_t i = 0; i < test.size(); i++)
		std::cout << "test[" << i << "] = " << test[i] << std::endl;
	...
	std::cout << col.yellow() << "resize with n == test.size()" << col.reset() << std::endl;
	test.resize(6);
	std::cout << "display the updated vector" << std::endl;
	for (std::size_t i = 0; i < test.size(); i++)
		std::cout << "test[" << i << "] = " << test[i] << std::endl;
	...
	/* CAPACITY */
	std::cout << col.bdBlue() << "Testing capacity method..." << col.reset() << std::endl;
	std::cout << "test.capacity = " << test.capacity() << std::endl;

	/* insert some values to check the changes in capacity */
	std::cout << col.yellow() <<"Checking changes in capacity related to augmentations in size..."
	<< col.reset() << std::endl;
	...
	std::cout << col.yellow() << "Checking changes in capacity related to diminutions in size..."
	<< col.reset() << std::endl;
	test.pop_back();
	test.pop_back();
	test.pop_back();
	...
	/* RESERVE */
	std::cout << col.bdBlue() << "testing reserve" << col.reset() << std::endl;
	std::cout << col.yellow() << "base test.capacity = " << col.reset() << std::endl;
	std::cout << "reserving a capacity of at least 67" << std::endl;
	test.reserve(67);
	std::cout << "new capacity = " << test.capacity() << std::endl;
	
	std::cout << col.yellow() << "reserving a capacity of 0 (should change nothing)" << col.reset() << std::endl;
	test.reserve(0);
	std::cout << "new capacity = " << test.capacity() << std::endl;
	
	std::cout << col.yellow() << "reserving a capacity superior to max_size() : should throw an error" 
	<< col.reset() << std::endl;
	try
	{
	...
	separator(col);
	std::cout << col.bdYellow() << "capacity tests over" << col.reset() << std::endl;
	separator(col);
}
...
{
	separator(col);
	std::cout << col.bdYellow() << "Testing methods to access elements in the vector..." << col.reset() << std::endl;
	separator(col);
	...
	std::cout << col.yellow() << "Verifying the behaviour of operator []" << col.reset() << std::endl;
	for (std::size_t i = 0; i < test.size(); i++)
		std::cout << "test[" << i << "] = " << test[i] << std::endl;
	
	std::cout << col.yellow() << "Testing test.at with valid indexes" << col.reset() << std::endl;
	for (std::size_t i = 0; i < test.size(); i++)
		std::cout << "test.at(" << i << ") = " << test.at(i) << std::endl;
	std::cout << col.yellow() << "Testing test.a with invalid index" << col.reset() << std::endl;
	try
	{
	...
	std::cout << col.yellow() << "Testing with test.data" << col.reset() << std::endl;
	...
	std::cout << col.yellow() << "Testing test.front and test.back" << col.reset() << std::endl;
	...
	separator(col);
	std::cout << col.bdYellow() << "Access tests over" << col.reset() << std::endl;
	separator(col);
}
...
{
	separator(col);
	std::cout << col.bdYellow() << "Testing assign..." << col.reset() << std::endl;
	separator(col);

	std::cout << col.bdBlue() << "Testing this assign version : template <class InputIterator>"
	<< "void assign (InputIterator first, InputIterator last);" << col.reset() << std::endl;
	...
	std::cout << col.yellow() << "Create another vector and its iterators begin and end..." << col.reset() << std::endl;
	...
	std::cout << col.yellow() << "using insert to replace the content of test vector by other_vect"
	<< col.reset() << std::endl;
	...
	std::cout << col.yellow() << "Testing assign with iterators from the same container" << col.reset() << std::endl;
	...
	std::cout << col.yellow() << "Testing assign with iterators from the same container again" << col.reset() << std::endl;
	try
	{
	...
	std::cout << col.yellow() << "Testing with iterators from another container of size 1" << col.reset() << std::endl;
	...
	std::cout << col.yellow() << "Testing reallocation with a bigger vector" << col.reset() << std::endl;
	...
	// ------------------------------------------------------------------------------------------------------//
	std::cout << col.bdBlue() << "Testing this assign version : void assign (size_type n, const value_type& val);" 
	<< col.reset() << std::endl;
	
	std::cout << col.yellow() << "assigning 42 times copies of values 42 to the test vector" << col.reset() << std::endl;
	test.assign(42, 42);
	std::cout << "Displaying the test vector after modifs" << std::endl;
	for (std::size_t i = 0; i< test.size(); i++)
		std::cout << "test[" << i << "] = " << test[i] << std::endl;
	...
	std::cout << col.yellow() << "assigning 0 times copies of values 42 to the test vector" << col.reset() << std::endl;
	test.assign(42, 42);
	std::cout << "Displaying the test vector after modifs" << std::endl;
	for (std::size_t i = 0; i< test.size(); i++)
		std::cout << "test[" << i << "] = " << test[i] << std::endl;
	...
	separator(col);
	std::cout << col.bdYellow() << "Assign tests over" << col.reset() << std::endl;
	separator(col);
}
...
static void	test_push_back(Colors &col) // to test
{
	...
	separator(col);
	std::cout << col.bdYellow() << "Push_back tests over" << col.reset() << std::endl;
	separator(col);
}
...
static void test_pop_back(Colors &col) // to test
{
	...
	// first deletion
	std::cout << col.bdBlue() << "trying pop_back method" << col.reset() << std::endl;
	std::cout << col.yellow() << "erase one value" << col.reset() <<  std::endl;
	test.pop_back();
	...
	std::cout << "size of the updated vector is : " << test.size() << std::endl;
	std::cout << "capacity of the updated vector is : " << test.capacity() << std::endl << std::endl;
	// note : not trying a sixth deletion because vector is empty (would cause undefined behaviour)
	
	separator(col);
	std::cout << col.bdYellow() << "pop_back tests over" << col.reset() << std::endl;
	separator(col);
}
...
static void test_insertion(Colors &col) // to test
{
	...
	std::cout << col.bdBlue() << "Testing this insert version : iterator insert(iterator position, const value_type &val);" 
	<< col.reset() << std::endl;

	std::vector<int>::iterator		it_pos = test.end();
	std::cout << col.yellow() <<"Insert a value (42) at the end" << col.reset() << std::endl;
	test.insert(it_pos, 42);
	std::cout << "Displaying the entire vector..." << std::endl;
	for (std::size_t i; i < test.size(); i++)
		std::cout << "index [" << i << "] = " << test[i] << std::endl;
	...
	it_pos = test.begin();
	std::cout << col.yellow() << "Insert a value (21) at the beginning" << col.reset() << std::endl;
	...
	std::cout << col.bdBlue() <<"testing with this insert version" 
	<< " : void insert(iterator position, size_type n, const value_type &val);" << col.reset() << std::endl;

	it_pos = test.end();
	std::cout << col.yellow() << "Inserting 5 values 72 at the end of the test vector" << col.reset() << std::endl;
	...
	it_pos = test.begin();
	std::cout << col.yellow() << "Inserting 5 values 47 at the beginning of the test vector" << col.reset() << std::endl;
	...
	std::cout << col.bdBlue() << "testing with this insert version : template <class InputIterator>" << std::endl
	<< "void insert(iterator position, InputIterator first, InputIterator last);" << col.reset() << std::endl;
	...
	std::cout << col.yellow() << "Add a range of values at the beginning of test" << col.reset() << std::endl;
	...
	std::cout << col.yellow() << "Add a range of values at the end of test " << col.reset() << std::endl;
	...
	separator(col);
	std::cout << col.bdYellow() << "insertion tests over" << col.reset() << std::endl;
	separator(col);
}
...
static void	test_erase(Colors &col) // to test
{
	...
	std::cout << col.bdBlue() << "Testing this erase version : iterator erase (iterator position);" 
	<< col.reset() << std::endl;
	...
	std::cout << col.yellow() <<  "Remove the first value using iterator begin" << col.reset() << std::endl;
	...
	std::cout << col.yellow() << "Remove the second value of test vector" << col.reset() << std::endl;
	...
	std::cout << col.yellow() <<  "Remove the last value of test vector" << col.reset() << std::endl;
	...
	std::cout << col.yellow() << "Trying to use erase using the iterator test.end() - 1" << col.reset() << std::endl;
	test.erase(test.end() - 1);
	for (std::size_t i = 0; i < test.size(); i++)
		std::cout << "test[" << i << "] = " << test[i] << std::endl;
	std::cout << "test size = " << test.size() << " and test capacity is " << test.capacity()
	...
	// ---------------------------------------------------------------------------------------------------- //
	std::cout << col.bdBlue() << "Testing this erase version : iterator erase (iterator first, iterator last);" 
	<< col.reset() << std::endl;
	...
	std::cout << col.yellow() << "remove the first and second values" << col.reset() << std::endl;
	...
	std::cout << col.yellow() << "remove using the same iterator (i.e. begin)" << col.reset() << std::endl;
	...
	std::cout << col.yellow() << "displaying the updated vector.." << col.reset() << std::endl;
	for (std::size_t i = 0; i < test.size(); i++)
		std::cout << "test[" << i << "] = " << test[i] << std::endl;
	std::cout << "test size = " << test.size() << " and test capacity is " << test.capacity()
	<< std::endl << std::endl;

	std::cout << col.yellow() << "remove using the same iterator (i.e. end)" << col.reset() << std::endl;
	...
	std::cout << col.yellow() << "removing all values using both begin and end iterators" << col.reset() << std::endl;
	...
	separator(col);
	std::cout << col.bdYellow() << "Erase tests over" << col.reset() << std::endl;
	separator(col);
}
...
{
	separator(col);
	std::cout << col.bdYellow() << "Testing equivalency operators..." << col.reset() << std::endl;
	separator(col);
	...
	std::cout << col.yellow() << "compare two equivalent int vectors" << col.reset() << std::endl;
	std::cout << "(comp1 == comp2) = " << std::boolalpha << (comp1 == comp2) << std::endl;
	std::cout << "(comp1 != comp2) = " << std::boolalpha << (comp1 != comp2) << std::endl;
	
	std::cout << col.yellow() << "compare two vectors with int vectors of different size" << col.reset() << std::endl;
	...
	separator(col);
	std::cout << col.bdYellow() << "End of equivalency operators tests" << col.reset() << std::endl;
	separator(col);
}
...
{
	separator(col);
	std::cout << col.bdYellow() << "Testing vector..." << std::endl << col.reset();
	separator(col);
	
	/* constructors */
	std::cout << col.bdBlue() <<  "test constructors..." << col.reset() << std::endl;
	test_constructors(col);
	/* iterators */
	std::cout << col.bdBlue() << "test iterators" << col.reset() << std::endl;
	test_iterator(col);

	// add const iterators there

	/* reverse iterators */
	std::cout << col.bdBlue() << "test reverse iterators" << col.reset() << std::endl;
	test_reverse_iterator(col);
	/* capacity */
	std::cout << col.bdBlue() << "test capacity methods" << col.reset() << std::endl;
	test_capacity_methods(col);
	/* access */
	std::cout << col.bdBlue() << "test access elements" << col.reset() << std::endl;
	test_access_elems(col);	
	/* assign */
	std::cout << col.bdBlue() << "test assign" << col.reset() << std::endl;
	test_assign(col);
	/* push back */
	std::cout << col.bdBlue() << "test push_back" << col.reset() << std::endl;
	test_push_back(col);	
	/* pop back */
	std::cout << col.bdBlue() << "test pop_back" << col.reset() << std::endl;
	test_pop_back(col);
	/* insertion */
	std::cout << col.bdBlue() << "test insertion" << col.reset() << std::endl;
	test_insertion(col);
	/* erase */
	std::cout << col.bdBlue() << "test erase" << col.reset() << std::endl;
	test_erase(col);
	/* equivalency */
	std::cout << col.bdBlue() << "test equivalency operators" << col.reset() << std::endl;
	test_equivalency_ops(col);

	separator(col);
	std::cout << col.bdYellow() << "End of vector tests" << col.reset() << std::endl;
	separator(col);
}
